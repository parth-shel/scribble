...
int pressEffect()
{
	...
	if (x>left && x<right && y>top && y<bottom && (button== WM_LBUTTONDOWN || button == WM_MOUSEMOVE)){ //btn press event
		int a=left;
		int b=top;
		unsigned int sz ;
...
cleardevice();
  ...
  outtextxy(20,250,"You can draw on the Scribble Pad using your mouse as a ");
  outtextxy(20,275,"pointing tool; Mouse Left Click to draw using the drawing ");
  outtextxy(20,300,"tool and Mouse Right Click to erase.");
  outtextxy(20,325,"You can save and work on your drawings using the 'Save' & ");
  outtextxy(20,350,"'Open' features. ");
  outtextxy(20,375,"These powerful tools help create a wonderful drawing ");
...
cleardevice();
  ...
  outtextxy(20,175,"to give you powerful tools for your creative ideas.");
  outtextxy(20,225,"   Credits :");
  outtextxy(20,250,"Design & Development - Parth Shelgaonkar");
...
cleardevice();
  ...
  arc(287,187,19,160,3);
  arc(303,203,290,71,3);
  line(35,425,140,425);
  line(90,435,170,435);
...
while(1)
{
 ...
 if(x>1+pensize && x<639-pensize && y<450-pensize && y>10+pensize && button==1 && drawselect==1){ // Drawing Tool
	 mousehide();
	 setcolor(pencolor);
 ...
 else if(x>6+pensize && x<634-pensize && y<445-pensize && y>15+pensize && button==2){ // Erasing Tool
	 mousehide();
	 setcolor(BLACK);
 ...
 else if(x>11+pensize && x<629-pensize && y<440-pensize && y>21+pensize && button==1 && drawselect==2){ //Airbrush Tool
	 spray(x,y,pensize,pencolor);
 }
 else if(x>1 && x<639 && y<450 && y>10 && button==1 && drawselect==6){//Circle Tool
		while(1){
			showmouseptr();
			getmousepos(&button,&x,&y);
			if(x>1 && x<639 && y>10 && y<450 && button==1){
				putpixel(x,y,pencolor);
				x1=x;y1=y;
				break;
				}
			}
		while(x>1 && x<639 && y>10 && y<450 && button==1){//drag mouse
			showmouseptr();
			getmousepos(&button,&x,&y);
			if(button==0){
				x2=x;y2=y;
...
else if(x>11+pensize && x<629-pensize && y<430-pensize && y>21+pensize && button==1 && drawselect==7){//Filled Circle Tool
	while(1){
		showmouseptr();
		getmousepos(&button,&x,&y);
		if(x>1 && x<639 && y>10 && y<450 && button==1){
 ...
 else if(x>1 && x<639 && y>10 && y<450 &&button==1 && drawselect==3){//Line Tool
	while(1){
		showmouseptr();
		getmousepos(&button,&x,&y);
		if(x>1 && x<639 && y>10 && y<450 && button==1){
 ...
 else if(x>1 && x<639 && y>10 && y<450 &&button==1 && drawselect==8){//Selection Tool
	while(1){
		showmouseptr();
		getmousepos(&button,&x,&y);
		if(x>1 && x<639 && y>10 && y<450 && button==1){
 ...
 else if(x>1 && x<639 && y>10 && y<450 &&button==1 && drawselect==4){//Box Tool
	while(1){
		showmouseptr();
		getmousepos(&button,&x,&y);
		if(x>1 && x<639 && y>10 && y<450 && button==1){
 ...
 else if(x>1 && x<639 && y>10 && y<450 &&button==1 && drawselect==5){//Filled Box Tool
	while(1){
		showmouseptr();
		getmousepos(&button,&x,&y);
		if(x>1 && x<639 && y>10 && y<450 && button==1){
